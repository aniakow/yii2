...
class Breadcrumbs extends Widget
{
    ...
    public $homeItemTemplate = "<span class=\"glyphicon glyphicon-home\"></span></a></li>";
    ...
    public function run()
    {
        ...
        //$glyph = ['class' => 'glyphicon glyphicon-home'];
        $links = [];
        if ($this->homeLink === null) {
            $links[] = $this->renderItem([
                'label' => Yii::t('yii', 'Home'),
                //'label' => Html::tag('span', '', $glyph),
                //'label' => '<span class="glyphicon glyphicon-home"></span>',
                'url' => Yii::$app->homeUrl,
            ], $this->itemTemplate);
        } elseif ($this->homeLink !== false) {
            $links[] = $this->renderItem($this->homeLink, $this->itemTemplate);
            //$links[] = $this->renderItem($this->homeLink, $this->$homeItemTemplate);
        }
